...
from lazylabel.config.hotkeys import HotkeyManager, HotkeyAction
...
class TestHotkeyManager:
    ...
    def test_get_actions_by_category(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert any(action.name == "save_segment" for action in categories["Actions"])
            assert any(action.name == "load_next_image" for action in categories["Navigation"])
